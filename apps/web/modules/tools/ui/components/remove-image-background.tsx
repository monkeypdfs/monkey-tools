    ...
    <div className="w-full">
      ...
      <Alert className="max-w-3xl mx-auto mt-6 text-yellow-800 border-yellow-200 bg-yellow-50 dark:bg-yellow-950/20 dark:border-yellow-800 dark:text-yellow-200">
        ...
        <AlertDescription className="text-yellow-700 dark:text-yellow-300">
          Background removal works best with images that have clear foreground subjects against simple backgrounds. Processing may
          take a few seconds per image depending on image size and complexity.
        </AlertDescription>
      </Alert>
    </div>
  );
