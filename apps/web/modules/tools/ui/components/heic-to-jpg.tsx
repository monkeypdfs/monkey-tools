  ...
  return (
    <div className="relative w-full py-10 overflow-hidden md:py-14 bg-background text-foreground">
      ...
      <div className="container relative z-10 px-4 mx-auto">
        <h1 className="text-5xl font-bold text-center">HEIC to JPG Converter</h1>
        <p className="my-6 text-base text-center">Convert HEIC images from iOS devices to widely supported JPG format.</p>
      ...
      <HowToStep
        ...
        steps={[
          { title: "Step 1", description: "Upload your HEIC image from iOS device" },
